...
// Each tier uses concrete, specific visual markers so the rendered image is immediately distinguishable at a glance.
const BUDGET_REALISM = {
  "Budget-friendly": "Budget-tier residential kitchen. CABINETS: Flat thermofoil or melamine doors with a flat matte plastic-like surface — no shadow lines, no depth, builder-grade appearance. COUNTERTOP: Solid-color laminate countertop with no veining and no texture — flat uniform non-stone surface, clearly laminate. RANGE: White or almond freestanding electric range with visible coil heating elements on the cooktop surface. HOOD: Basic over-range microwave unit or small flat metal exhaust box — compact and utilitarian, not decorative. LIGHTING: Single overhead fluorescent tube light or basic ceiling-mounted globe fixture — no under-cabinet lighting and no glow visible under upper cabinets. HARDWARE: Small simple chrome round knobs. BACKSPLASH: Plain painted white wall or no backsplash material behind the countertop. Overall: functional and utilitarian — unmistakably builder-grade low-budget construction quality.",
  "Modern Euro":     "Mid-range contemporary residential kitchen. CABINETS: Flat-panel or shaker cabinet doors in matte white or light gray — crisp machine-cut edges, smooth painted surface, clearly upgraded above builder-grade. COUNTERTOP: Light gray or white quartz slab countertop with subtle veining pattern — polished stone-like surface with visible texture, noticeably better than laminate. RANGE: Stainless steel slide-in range with sealed gas burners and visible silver or brass burner grates, paired with a matching stainless chimney-style hood mounted to wall above. LIGHTING: Warm LED recessed ceiling lights plus a continuous LED light strip glowing visibly beneath upper cabinets — warm yellow-white glow clearly visible on the countertop surface below. HARDWARE: Matte black or brushed satin nickel long bar pull handles on all cabinets. BACKSPLASH: White rectangular subway tile in a running bond pattern covering the wall behind the countertop. Overall: clean, contemporary, mid-range residential — clearly a step above basic, modern and well-finished.",
  "Premium Luxury":  "High-end luxury residential kitchen. CABINETS: Custom inset cabinet doors sitting perfectly flush inside their face frames — precise shadow-line gaps visible around every door panel indicating master-level craftsmanship, painted in a deep rich tone or natural wood veneer. COUNTERTOP: Thick natural marble or book-matched quartzite slab with bold dramatic veining in gray, gold, or green tones — waterfall edge visibly flowing down the full side of the island. RANGE: Professional-grade stainless 6-burner range (Wolf or La Cornue proportions) with heavy cast-iron grates and brass control knobs — large commanding focal point. HOOD: Tall custom statement range hood in plaster, painted wood, or heavy custom steel with architectural molding — spans from counter height to ceiling as a dominant visual element. LIGHTING: Layered warm lighting visible throughout — large decorative pendant lights hang over the island, warm under-cabinet LED strips glow on every countertop section, concealed toe-kick lighting glows at floor level. HARDWARE: Unlacquered aged brass cabinet hardware with visible warm patina depth. BACKSPLASH: Full-height slab stone behind the range extending to the ceiling with veining continuous from countertop, or large-format artisan handmade tiles. Overall: unmistakably high-end custom luxury — every surface signals expensive craftsmanship and premium materials.",
};

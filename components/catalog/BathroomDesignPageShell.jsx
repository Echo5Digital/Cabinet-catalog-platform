      ...
      {!designVerified && (
        <div className="relative overflow-hidden" style={{ background: "linear-gradient(160deg, #4A0A15 0%, #6E1020 55%, #7D1528 100%)" }}>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16 relative z-10 text-center">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-bold text-white mb-4 anim-fade-in-up leading-tight" style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}>
              Bathroom Design AI
            </h1>
            <p className="text-red-100/75 max-w-xl mx-auto leading-relaxed mb-8">
              Tell us about your dream bathroom and we&apos;ll generate personalized design concepts,
              vanity recommendations, and a sales-ready summary — instantly.
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                { step: "1", title: "Fill in your details", desc: "Type, style, colors, and faucet" },
                { step: "2", title: "AI generates concepts", desc: "A realistic design matched to your inputs" },

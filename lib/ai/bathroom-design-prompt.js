...
- L-Shaped: vanity and toilet along one wall, shower/tub turning the corner onto the adjoining wall — a two-wall L footprint.
- Galley: vanity on one wall facing shower/tub and toilet on the opposite parallel wall, with a walkway corridor between them.
- Single Wall: vanity, toilet, and shower/tub all aligned along a single wall in a compact linear run.
- U-Shaped: vanity on the back wall with toilet and shower/tub on the two side walls, wrapping three walls around a central floor area.
...
- NEVER omit the style's DEFINING fixture layout: "L-Shaped" MUST show the shower/tub turning the corner
  onto a second, perpendicular wall — never all fixtures flattened onto one wall. "Galley" MUST show the
  vanity and shower/tub on two separate PARALLEL walls facing each other with a walkway between — never

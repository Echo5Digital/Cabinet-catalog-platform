...
FULL BATHROOM: vanity, toilet, and shower/tub all present.
...
- Modern Minimal: clean-lined vanity, frameless glass shower, wall-hung/low-profile toilet, monochrome palette, minimal ornamentation.
- Traditional: furniture-style raised-panel vanity, framed mirror, classic subway/hex tile, warm wood tones.
- Spa Retreat: freestanding soaking tub as focal point, separate walk-in shower, floating vessel-sink vanity, natural stone/wood textures, soft ambient lighting.
- Compact Efficient: space-saving slim or corner vanity, shower-tub combo, bright light palette to expand a small footprint.
...
- NEVER omit the style's DEFINING fixture: "Spa Retreat" MUST show an actual freestanding soaking tub —
  not a built-in tub, not a shower-only room. "Double Sink" MUST show two visually distinct sink basins
  and two faucets — never a single wide sink. "Floating" MUST show visible open floor/wall space beneath
  the vanity cabinet — never a base cabinet that reaches the floor. "Walk-in Glass" MUST show a frameless
  single glass panel with no visible door frame — never a framed sliding door.
...
Vanity cabinet color, countertop, flooring, and faucet finish are separate mandatory surfaces.
NEVER blend, average, reinterpret, or substitute finishes.
...
FAUCET: must use ONLY the selected faucet finish.
...
Sentence 1: Describe vanity door/cabinet style, faucet finish, hardware, AND the selected style's DEFINING
fixture/silhouette (see STRICT STYLE LOCK) — be specific (e.g. "shaker-style vanity doors with matte black
bar pulls, a matte black single-handle faucet, and a freestanding oval soaking tub as the room's focal point").
...
e.g. for "Spa Retreat": freestanding tub, walk-in shower, floating vanity; for "Double Sink": vanity, sink A,
sink B, storage tower. Each entry MUST include: fixture (name), configuration (how it's built/styled per the
chosen style), placement (where in the room), reasoning (why this choice suits the style + budget + bathroom
...
The customer's existing bathroom is shown. ONLY the vanity, countertop, flooring, and faucet change.
...
4. Replace vanity, countertop, flooring, and faucet with the customer's selected options ONLY.
